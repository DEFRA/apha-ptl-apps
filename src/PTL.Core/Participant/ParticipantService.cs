...
public sealed class ParticipantService(IParticipantRepository participantRepository, ILogger<ParticipantService> logger) : IParticipantService
{
    ...
    private static readonly Action<ILogger, Guid, Exception?> LogUpdateUnknownParticipantMessage =
        LoggerMessage.Define<Guid>(
            LogLevel.Warning,
            new EventId(2, nameof(LogUpdateUnknownParticipantMessage)),
    ...
    private static readonly Action<ILogger, Guid, Exception?> LogDeactivateUnknownParticipantMessage =
        LoggerMessage.Define<Guid>(
            LogLevel.Warning,
            new EventId(4, nameof(LogDeactivateUnknownParticipantMessage)),
    ...
    private static readonly Action<ILogger, Guid, Exception?> LogReactivateUnknownParticipantMessage =
        LoggerMessage.Define<Guid>(
            LogLevel.Warning,
            new EventId(6, nameof(LogReactivateUnknownParticipantMessage)),
    ...
    public async Task<Participant?> UpdateParticipantAsync(Guid participantId, Participant updatedFields, CancellationToken cancellationToken = default)
    {
        ...
        if (existing is null)
        {
            LogUpdateUnknownParticipantMessage(logger, participantId, null);
            return null;
        }
    ...
    public async Task<Participant?> DeactivateParticipantAsync(Guid participantId, CancellationToken cancellationToken = default)
    {
        ...
        if (existing is null)
        {
            LogDeactivateUnknownParticipantMessage(logger, participantId, null);
            return null;
        }
    ...
    public async Task<Participant?> ReactivateParticipantAsync(Guid participantId, CancellationToken cancellationToken = default)
    {
        ...
        if (existing is null)
        {
            LogReactivateUnknownParticipantMessage(logger, participantId, null);
            return null;
        }
